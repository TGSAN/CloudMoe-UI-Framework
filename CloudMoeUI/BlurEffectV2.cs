...
using static CloudMoeUI.BlurEffect;
...
namespace CloudMoeUI
{
    class BlurEffectV2
    {
        public static readonly DependencyProperty IsEnabledProperty = DependencyProperty.RegisterAttached(
            "IsEnabled", typeof(bool), typeof(BlurEffectV2),
        ...
        public static readonly DependencyProperty WindowBlurProperty = DependencyProperty.RegisterAttached(
            "WindowBlur", typeof(BlurEffectV2), typeof(BlurEffectV2),
        ...
        public static BlurEffectV2 GetWindowBlur(DependencyObject element)
        {
            return (BlurEffectV2)element.GetValue(WindowBlurProperty);
        }
        ...
        private static void OnWindowBlurChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (d is Window window)
            {
                (e.OldValue as BlurEffectV2)?.Detach();
                (e.NewValue as BlurEffectV2)?.Attach(window);
            }
        }
